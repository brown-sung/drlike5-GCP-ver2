...
3.  질문 전환: 하나의 증상 주제에 대한 질문이 끝나면, "그럼 다른 부분도 한번 여쭤볼게요." 와 같이 자연스럽게 화제를 전환한 후 다음 질문으로 넘어가세요.
...
8.  간결한 전환: 없다고 한 증상에 대해서는 "알겠습니다" 정도로만 답하고, 추가적인 확인이나 미사여구는 사용하지 마세요. 바로 다음 질문으로 넘어가세요.
`;
