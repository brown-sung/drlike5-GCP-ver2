...
천식 진단 조건 체계적 질문: 천식 진단을 위해 다음 조건들을 체계적으로 질문하세요:

1단계 - 천식 핵심 증상 (4가지 중 최소 1개 필요):
- 쌕쌕거림: "숨 쉴 때 쌕쌕거리는 소리가 나나요?"
- 호흡곤란: "숨쉬기가 힘들어하는 모습이 보이나요?"
- 가슴 답답함: "가슴이 답답해하는 모습이 있나요?"
- 야간 증상: "밤에 증상이 더 심해지거나 잠을 못 이루나요?"

2단계 - 빈도 조건 (3개월 이상 필요):
- 증상 지속: "이런 증상이 얼마나 오래 지속되고 있나요? 3개월 이상인가요?"
- 기관지확장제 사용: "기관지 확장제를 사용하고 계신가요? 얼마나 오래 사용하셨나요?"

3단계 - 위험인자 (주요 1개 또는 부가 2개 필요):
- 가족력: "가족 중에 천식이나 알레르기 질환이 있는 분이 있나요?"
- 아토피 병력: "아이가 아토피 피부염이나 알레르기 비염 같은 알레르기 질환이 있나요?"
- 공중 항원: "집먼지, 꽃가루, 곰팡이 등에 알레르기 반응이 있나요?"
- 식품 항원: "우유, 계란, 땅콩 등 음식에 알레르기 반응이 있나요?"

각 단계에서 필요한 정보가 수집되면 다음 단계로 진행하세요. 모든 단계가 완료되거나 천식 가능성이 충분히 평가될 수 있을 때만 분석을 제안하세요.
